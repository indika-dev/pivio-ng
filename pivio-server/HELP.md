...
* The original package name 'de.indisopht.pivio-server' is invalid and this project uses 'de.indisopht.pivioserver' instead.
...
* [Mustache](https://docs.spring.io/spring-boot/docs/3.2.5/reference/htmlsingle/index.html#web.servlet.spring-mvc.template-engines)
...
```
$ docker run --rm pivio-server:0.0.1-SNAPSHOT
```
